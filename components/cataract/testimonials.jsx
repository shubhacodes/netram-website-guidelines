  ...
  return (
    <section id="testimonials" style={{ backgroundColor: green }}>
      <div className="mx-auto max-w-6xl px-4 py-16">
        {/* Heading */}
        <h2
          className="text-4xl md:text-5xl font-extrabold text-center mb-12 font-freight"
          style={{ color: cream }}
        >
        ...
        <div className="relative">
          ...
          <div className="overflow-x-auto -mx-4 px-4 mb-12 scroll-smooth" ref={scrollContainerRef}>
            <div className="flex gap-8 py-4">
              {reels.map((url, i) => (
                <div key={i} className="w-[350px] h-[600px] flex-shrink-0 bg-[#1e3a2a]">
                  <InstagramEmbed
                    url={url}
                    width="100%"
                    height="100%"
