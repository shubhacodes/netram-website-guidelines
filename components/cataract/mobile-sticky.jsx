        ...
        >
          ...
          <div className="grid h-[68px] grid-cols-3 px-4">
            ...
            >
              ...
              <span className="mt-1 text-xs font-semibold font-proxima" style={{ color: BTN_COLOR }}>Book Now</span>
            ...
            >
              ...
              <span className="mt-1 text-xs font-semibold font-proxima" style={{ color: BTN_COLOR }}>WhatsApp</span>
              <div className="absolute right-0 top-[15%] bottom-[15%] w-px bg-gray-200" />
            </Link>
            ...
            >
              ...
              <span className="mt-1 text-xs font-semibold font-proxima" style={{ color: BTN_COLOR }}>Call Now</span>
            </Link>
          </div>
        </div>
      </footer>
